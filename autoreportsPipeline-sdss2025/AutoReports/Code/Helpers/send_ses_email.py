...
class EmailSender:
    def __init__(self, report_log_df):
        ...
        # , "mkruse@air.org", "checkman@air.org", "jjuarez@air.org", "cjones@air.org"
        self.data_science_team = ["gchickering@air.org", "checkman@air.org"]
        self.project_team = ["jshively@air.org","charrison@air.org","gchan@air.org", "cjones@air.org"]
        # self.data_science_team = ["gchickering@air.org"]
        # self.project_team = ["gchickering@air.org"]
