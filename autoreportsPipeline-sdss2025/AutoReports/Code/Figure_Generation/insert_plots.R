...
add_table_graphic <- function(data, width = 400, height = 200, units = "px", scale = 2, text_scalar = 1, bg = "transparent", anchor = "north west", xshift = 0, yshift = 0, alt = "", single_page_version = FALSE, report_name = "",output_path = "") {
  filename <- paste0("5e_table_graphic_", data$Figure_num[1], ".png" )
  ...
  if (units == "pt") {
    ggsave(file.path(output_path, filename), plot = plt, width = width * scale, height = height * scale, units = "px", bg = bg, dpi = 400)
  } else {
    ggsave(file.path(output_path, filename), plot = plt, width = width * scale, height = height * scale, units = units, bg = bg, dpi = 400)
  }
...
add_survey_response_graphic <- function(data, width = 765, height = 150, units = "px", scale = 10, text_scalar = 1.1, bg = "transparent", anchor = "north west", xshift = 35, yshift = -60, alt = "", single_page_version = FALSE, report_name = "", output_path = "") {
  filename <- paste0("survey_response_graphic_", data$Figure_num[1], ".png")
  ...
  #ggsave(filename, plot = plt, width = width * scale, height = height * scale, units = units, bg = bg, dpi = 400)
